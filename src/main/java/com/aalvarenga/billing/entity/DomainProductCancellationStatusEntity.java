...
/**
 * Mapeia {@code T_DOMAIN_PRODUCT_CANCELLATION_STATUS} (criada em
...
@AllArgsConstructor
@Entity
@Table(name = "T_DOMAIN_PRODUCT_CANCELLATION_STATUS")
public class DomainProductCancellationStatusEntity {
